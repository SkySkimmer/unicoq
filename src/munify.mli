...
val unify_evar_conv : Names.transparent_state -> unify_fun
...
(** Given a set of evars s and terms t1 t2, it unifies the terms only
    ...
    (t2) is reduced.  *)
val unify_match : Evar.Set.t -> Names.transparent_state -> unify_fun

(** Same as unify_match but with no reduction *)
val unify_match_nored : Evar.Set.t -> Names.transparent_state -> unify_fun
